...
class Snap_Scroll {
	 ...
	 * @var      string
	 */
	protected $plugin_slug = 'snap-scroll';
	...
	private function __construct() {
		 ...
		 */
		add_action ( 'wp_footer', array( $this, 'scroll_snap' ), 100 );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_slug . '-plugin-script', plugins_url( 'js/snap-scroll-custom.min.js', __FILE__ ), array( 'jquery' ), self::VERSION );
	}
	 ...
	 */
	 ...
	 public function scroll_snap() { 
		 
	 	$basics = get_option('snap_basics');
	 	echo "<script type='text/javascript'>
				jQuery(document).ready(function() {

					jQuery(document).scrollsnap({
						snaps: '".$basics['snaps']."',
						easing: '".$basics['easing']."',
						direction: '".$basics['direction']."',	  
						proximity: ".$basics['proximity']." ,	 
						offset: ".$basics['offset'].",
						once: '".$basics['once']."',		 
